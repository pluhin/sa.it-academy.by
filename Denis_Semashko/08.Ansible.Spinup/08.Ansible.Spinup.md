...
skipping: [ubuntu_01] => (item=http://mirror.datacenter.by/pub/CentOS) 
skipping: [ubuntu_01] => (item=http://mirror.yandex.ru/centos) 
skipping: [ubuntu_01] => (item=http://centos2.hti.pl) 
skipping: [ubuntu_01] => (item=http://mirror.atlanticmetro.net/centos) 
ok: [centos_01] => (item=http://mirror.datacenter.by/pub/CentOS)
ok: [centos_01] => (item=http://mirror.yandex.ru/centos)
ok: [centos_01] => (item=http://centos2.hti.pl)
ok: [centos_01] => (item=http://mirror.atlanticmetro.net/centos)

TASK [test : Check connection to repository Ubuntu] **************************************************************************************************************************************************************
Sunday 17 November 2019  07:12:13 +0300 (0:00:02.509)       0:00:03.745 ******* 
skipping: [centos_01] => (item=http://mirror.yandex.ru/ubuntu) 
skipping: [centos_01] => (item=http://ftp.byfly.by/ubuntu) 
skipping: [centos_01] => (item=http://mirror.linux-ia64.org/ubuntu) 
skipping: [centos_01] => (item=http://ftp.icm.edu.pl/pub/Linux/ubuntu) 
ok: [ubuntu_01] => (item=http://mirror.yandex.ru/ubuntu)
ok: [ubuntu_01] => (item=http://ftp.byfly.by/ubuntu)
ok: [ubuntu_01] => (item=http://mirror.linux-ia64.org/ubuntu)
ok: [ubuntu_01] => (item=http://ftp.icm.edu.pl/pub/Linux/ubuntu)
...
skipping: [centos_01] => (item={'block_used': 745263, 'uuid': '8ac075e3-1124-4bb6-bef7-a6811bf8b870', 'size_total': 42927656960, 'block_total': 10480385, 'mount': '/', 'block_available': 9735122, 'size_available': 39875059712, 'fstype': 'xfs', 'inode_total': 20971008, 'options': 'rw,seclabel,relatime,attr2,inode64,noquota', 'device': '/dev/sda1', 'inode_used': 27386, 'block_size': 4096, 'inode_available': 20943622}) 
skipping: [ubuntu_01] => (item={'block_used': 1154756, 'uuid': '50047540-6eaa-46ba-a530-5244154bec34', 'size_total': 65735069696, 'block_total': 16048601, 'mount': '/', 'block_available': 14893845, 'size_available': 61005189120, 'fstype': 'ext4', 'inode_total': 4087808, 'options': 'rw,relatime,errors=remount-ro,data=ordered', 'device': '/dev/mapper/vagrant--vg-root', 'inode_used': 40692, 'block_size': 4096, 'inode_available': 4047116}) 
skipping: [ubuntu_01] => (item={'block_used': 24111, 'uuid': '8e412185-8692-431c-a753-9a63c3cd9d51', 'size_total': 754434048, 'block_total': 184188, 'mount': '/boot', 'block_available': 160077, 'size_available': 655675392, 'fstype': 'ext2', 'inode_total': 46848, 'options': 'rw,relatime', 'device': '/dev/sda1', 'inode_used': 302, 'block_size': 4096, 'inode_available': 46546}) 

PLAY RECAP *******************************************************************************************************************************************************************************************************
centos_01                  : ok=5    changed=1    unreachable=0    failed=0   
ubuntu_01                  : ok=5    changed=1    unreachable=0    failed=0   

Sunday 17 November 2019  07:12:17 +0300 (0:00:00.046)       0:00:08.254 ******* 
=============================================================================== 
test : Check connection to repository CentOS -------------------------------------------------------------------------------------------------------------------------------------------------------------- 2.51s
test : Check connection to repository Ubuntu -------------------------------------------------------------------------------------------------------------------------------------------------------------- 1.86s
test : Check connection to docker hub registry ------------------------------------------------------------------------------------------------------------------------------------------------------------ 1.83s
Gathering Facts ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 0.87s
test : Check connection to repository pip ----------------------------------------------------------------------------------------------------------------------------------------------------------------- 0.73s
test : Check run sudo without password -------------------------------------------------------------------------------------------------------------------------------------------------------------------- 0.31s
test : Checking the availability of the HDD capacity ------------------------------------------------------------------------------------------------------------------------------------------------------ 0.05s
test : Checking the availability of required RAM memory --------------------------------------------------------------------------------------------------------------------------------------------------- 0.03s
```
...
```bash
--> Validating schema /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default/molecule.yml.
...
--> Scenario: 'default'
--> Action: 'lint'
--> Executing Yamllint on files found in /home/denis7hko/it-academy/Vagrant/roles/test/...
Lint completed successfully.
--> Executing Flake8 on files found in /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default/tests/...
Lint completed successfully.
--> Executing Ansible Lint on /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default/playbook.yml...
Lint completed successfully.
--> Scenario: 'default'
--> Action: 'dependency'
...
--> Sanity checks: 'docker'
    ...
    playbook: /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default/playbook.yml
--> Scenario: 'default'
--> Action: 'create'
...
--> Scenario: 'default'
--> Action: 'verify'
--> Executing Testinfra tests found in /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default/tests/...
    ============================= test session starts ==============================
    platform linux -- Python 3.7.3, pytest-5.2.4, py-1.8.0, pluggy-0.13.0
    rootdir: /home/denis7hko/it-academy/Vagrant/roles/test/molecule/default
