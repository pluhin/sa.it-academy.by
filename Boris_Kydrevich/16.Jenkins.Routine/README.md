...
Running as SYSTEM
Building in workspace /var/jenkins_home/workspace/16.Jenkins.Routine/homework
[homework] $ /bin/sh /tmp/jenkins5576706294313232829.sh
PING 192.168.203.11 (192.168.203.11) 56(84) bytes of data.
64 bytes from 192.168.203.11: icmp_seq=1 ttl=64 time=0.109 ms
64 bytes from 192.168.203.11: icmp_seq=2 ttl=64 time=0.103 ms
64 bytes from 192.168.203.11: icmp_seq=3 ttl=64 time=0.097 ms

--- 192.168.203.11 ping statistics ---
3 packets transmitted, 3 received, 0% packet loss, time 50ms
rtt min/avg/max/mdev = 0.097/0.103/0.109/0.005 ms
[homework] $ /bin/bash /tmp/jenkins571424154193226110.sh
...
Nmap scan report for 192-168-203-11.kubernetes.default.svc.cluster.local (192.168.203.11)
...
[homework] $ /bin/bash /tmp/jenkins5906311417675203772.sh
...
Processing triggers for libc-bin (2.28-10) ...
[homework] $ /bin/bash /tmp/jenkins1645711835015000627.sh
########HOSTS ONLINE#############
# Nmap 7.70 scan initiated Mon Apr 19 13:46:43 2021 as: nmap -sP -o output.xml 192.168.203.0/24
Nmap scan report for 192.168.203.1
Host is up (0.00040s latency).
Nmap scan report for 192.168.203.2
Host is up (0.00032s latency).
...
Nmap scan report for 192.168.203.24
Host is up (0.0025s latency).
# Nmap done at Mon Apr 19 13:46:59 2021 -- 256 IP addresses (23 hosts up) scanned in 16.51 seconds
Finished: SUCCESS
