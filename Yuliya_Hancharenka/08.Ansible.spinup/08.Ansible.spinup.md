...
##### 2 Implementing tests
 Molecule tests passed partially because of Docker daemon configuration regardin Active Docker running status
```bash
...
active
yhancharenka@yhancharenka-VirtualBox:~/ansiblerun/roles$ molecule test
--> Validating schema /home/yhancharenka/ansiblerun/roles/molecule/default/molecule.yml.
Validation completed successfully.
--> Test matrix
