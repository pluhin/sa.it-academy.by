...
resource "docker_container" "nginx" {
    ...
    volumes {
      host_path      = "/home/vit/Work/10.Docker.Compose/web/"
...
resource "docker_container" "radarr" {
    ...
    volumes {
      ...
      host_path = "/home/vit/Work/10.Docker.Compose/radarr/data"
      container_path = "/config"
      read_only      = false
  }
    volumes {
      volume_name    = docker_volume.radarr_movies.name
      host_path = "/home/vit/Work/10.Docker.Compose/radarr/movies"
      container_path = "/tv"
      read_only      = false
  }
    volumes {
      volume_name    = docker_volume.radarr_downloads.name
      host_path = "/home/vit/Work/10.Docker.Compose/radarr/downloadclient-downloads"
      container_path = "/downloads"
      read_only      = false
  }
}
