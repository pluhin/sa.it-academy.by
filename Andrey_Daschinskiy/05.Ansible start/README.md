...
[all:vars]
ansible_user=root
ansible_ssh_common_args='-o StrictHostKeyChecking=no -o ProxyCommand="sshpass -p 103f46b0bf13870c8a856592a1281577 ssh -W %h:%p -p 32510 jump_sa@178.>
...
- name: Create a user
  ...
  vars:
    ...
    user_password: "{{ 'StudentPass123!' | password_hash('sha512') }}"
