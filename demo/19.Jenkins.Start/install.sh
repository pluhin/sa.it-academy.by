...
cp -v /home/user/19.Jenkins/01_AuthorizationStrategy.groovy /var/lib/jenkins/init.groovy.d/
cp -v /home/user/19.Jenkins/02_addUser.groovy /var/lib/jenkins/init.groovy.d/
