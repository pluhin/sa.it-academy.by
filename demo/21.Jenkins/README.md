...
pipeline {
    ...
    parameters {
        ...
        string(name: 'parent_host', defaultValue: '702', description: 'ID on template:\n 702 - for k8s\n 704 - for k3s')
    ...
    stages {
        stage('K8s') {
            ...
            steps {
                sshagent(credentials: ['sa_private_key']) {
                    ansiblePlaybook(
...
https://github.com/pluhin/multibranches/tree/feature_01
