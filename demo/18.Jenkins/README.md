...
pipeline {
    ...
    stages {
        stage('Clone repository') {
            steps {
                git url: 'https://github.com/pluhin/flux-demo.git', branch: 'main', credentialsId: "some_randome"
            }
        }
        ...
        stage('parallel') {
            parallel {
                stage('Clone repository 01') { 
                    steps { 
                        dir('01') {
                            git url: 'https://github.com/pluhin/flux-demo.git', branch: 'main'
                            sh """
...
pipeline {
    ...
    stages {
        stage('Clone repository') {
            steps {
                    deleteDir()
                    git url: 'https://github.com/pluhin/docker-icinga2.git',
