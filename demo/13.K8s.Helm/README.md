```bash
 ...
 706  cd 13.K8s.Helm/
  ...
  753  git remote add origin git@github.com:pluhin/helm-27-24.git
  754  git push -u origin master
  755  echo -e "User-Agent: *\nDisallow: /" > robots.txt
  756  helm repo index --url "https://pluhin.github.io/helm-27-24/" .
  757  vim index.yaml
  758  git add --all
  ...
  762  cd /tmp/
  763  ls
  764  helm repo add helm-27-24 https://pluhin.github.io/helm-27-24/
  765  helm repo update
  766  helm search repo helm-27-24 -l
  767  helm install fist-app helm-27-24/first-app -n default
  768  helm uninstall fisrt-app
  ...
  775  vim 2q
  776  rm 2q
  777  vim first-app/values.yaml
  778  vim ../../12.K8s.Data.Secrets/app.yaml
  779  vim first-app/values.yaml
  780  vim ../../12.K8s.Data.Secrets/app.yaml
  781  vim first-app/values.yaml
  782  vim first-app/templates/
  783  vim first-app/templates/pvc.yaml
  784  vim first-app/values.yaml
  785  vim first-app/templates/pvc.yaml
  786  vim first-app/values.yaml
  787  vim first-app/templates/pvc.yaml
  788  vim first-app/templates/deployment.yaml
  789  vim first-app/values.yaml
  790  vim first-app/Chart.yaml
  791  helm package first-app
  792  ls -l
  793  helm install first-app --dry-run first-app-0.2.0.tgz -n default
  ...
  809  helm search helm-27-24 -l
  810  helm search repo helm-27-24 -l
  811  history | grep install
  812  helm install fist-app helm-27-24/first-app --version 0.2.0 -n default
  813  cd 06.Ansible/
  814  ls
  815  vim mysql.yaml
