...
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '583170665458.14334', 'results_file': '/home/usr/.ansible_async/583170665458.14334', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/centos:8', 'name': 'instance_cent', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '666296134005.14362', 'results_file': '/home/usr/.ansible_async/666296134005.14362', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/debian:latest', 'name': 'instance_deb', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
changed: [localhost] => (item={'started': 1, 'finished': 0, 'ansible_job_id': '812037247316.14392', 'results_file': '/home/usr/.ansible_async/812037247316.14392', 'changed': True, 'failed': False, 'item': {'image': 'docker.io/pycontribs/alpine:latest', 'name': 'instance_alpine', 'pre_build_image': True}, 'ansible_loop_var': 'item'})
