...
Vagrant.configure("2") do |config|
  ...
  config.vm.network "public_network", ip: "192.168.100.205",  bridge: "wlo0"
...
SCRIPT    config.vm.provision "minikube", type: "shell", inline: <<-SCRIPT
echo "Downloading minikube"
curl -Lo minikube https://storage.googleapis.com/minikube/releases/latest/minikube-linux-amd64 && chmod +x minikube && sudo mv minikube /usr/local/bin
SCRIPT    config.vm.provision "k8s", type: "shell", inline: <<-SCRIPT
...
![](https://i.ibb.co/Gs6B015/k8panel.png)
