...
---
[>> Docker Hub Registry <<](https://hub.docker.com/repository/docker/svvsvv/docker_build/tags?page=1&ordering=last_updated)

[>> GitHub Container Registry <<](https://github.com/users/svvsvv/packages/container/package/docker_build)
      ...
      - name: Build and push docker image
        ...
        with:
          ...
          tags: |
            ...
            ghcr.io/svvsvv/docker_build:${{ github.sha }}
            ghcr.io/svvsvv/docker_build:${{ github.run_number }}
