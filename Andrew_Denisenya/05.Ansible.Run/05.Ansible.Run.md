...
## Create user (create new user, user auth only by key, add to the sudo:nopasswd)

```bash
ansible-playbook add_user.yaml -i inventory/main.yaml
...
TASK [Add a new user named test6] *******************************************************************************
changed: [vm2]
changed: [vm1]
