  225  clear
  226  git add --all
  227  git commit -m "conflict in second"
  228  git branch
  229  git rebase master
  230  vim first.txt
  231  git add --all
  232  git merge second
  233  git checkout master
  234  git checkout
  235  git branch
  236  git log --oneline 
  237  cgfit checkout 75c6f86
  238  ls -la
  239  logout
  240  quit
  241  exit
  ...
  260  ls 
  261  ls -la
  262  sudo apt-get install mc
  263  mc
  264  git clone https://github.com/Stanishevski/sa.it-academy.by
  265  git version
  266  mc
  267  ping sa.it-academy.by
  268  git clone https://github.com/Stanishevski/sa.it-academy.by.git
  269  gh repo clone stanishevski/sa.it-academy.by
  270  sudo snap install gh
  271  gh repo clone stanishevski/sa.it-academy.by
  272  Stanishevski
  273  gh repo clone stanishevski/sa.it-academy.by
  274  gh auth login stanishevski
  275  gh repo clone stanishevski/sa.it-academy.by
  276  gh auth login
  277  ct first.txt
  278  ls
  279  lc
...
/#HOTFIX DEPLOY
Fri 02 Dec 2022 03:29:37 PM UTC
