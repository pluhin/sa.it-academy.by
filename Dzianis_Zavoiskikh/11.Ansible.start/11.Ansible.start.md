...
```bash
ansible -i dz_hosts.yaml ec_203_78 -m setup | grep -E '(hostname|"address": "19)'
```
![alt text](https://github.com/Logy777/02.Git.Local/blob/master/11.Ansible/get_hostname%26address.JPG "tail output snapshot")
