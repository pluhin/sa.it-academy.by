...
```bash
ssh -L 8080:127.0.0.1:8080 goshaker@192.168.211.132 -f -N
```

Screenshot of the webpage
![Webpage Screenshot](https://github.com/Goshaker/DevOpsCourse/blob/master/08.Docker.Compose/Drupal_screen.png)
...
[Github repo for task 2](https://github.com/Goshaker/08.Docker.Compose)
    ...
    steps:
      ...
      - name: Build and push Docker images
        ...
        with:
          context: .
          push: true
          tags: ghcr.io/goshaker/08.docker.compose
```
